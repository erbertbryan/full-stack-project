...
from courses.views import CoursesView, CreateCourseView, StudentApiView,CourseUpdateView
...
urlpatterns = [
    ...
    path('courses/update/<int:course_id>/', CourseUpdateView.as_view(), name='courses_update'),
